...
data_lookup = value["products"]

for values in data_lookup:
    print("The Product is",values["title"])
    print("The Price is",values["price"])
    for rev in values["reviews"]:
     print("The Rating is ", rev["rating"])
     print("The Comment is ", rev["comment"])
    print("\n")
